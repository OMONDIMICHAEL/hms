<x-app-layout>
    ...
    <form action="{{ route('patients.update', $patient) }}" method="POST">
        ...
        <div class="flex items-center space-x-3 mt-4">
            ...
            <a href="{{ route('patients.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
