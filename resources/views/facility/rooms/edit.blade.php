    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden p-8">
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update the details for room {{ $room->room_number }}.</p>
            </div>
            ...
            <form action="{{ route('rooms.update', $room) }}" method="POST" class="space-y-6">
                ...
                <!-- Room Number -->
                <div>
                    <label for="room_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Room Number <span class="text-red-500">*</span></label>
                    <div class="relative">
                        <input type="text" name="room_number" id="room_number" required
                            ...
                            placeholder="e.g. 101" value="{{ old('room_number', $room->room_number) }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="capacity" id="capacity" required min="1"
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100"
                            placeholder="e.g. 4" value="{{ old('capacity', $room->capacity) }}">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex justify-end pt-4 space-x-3">
                    <a href="{{ route('rooms.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-gray-700 uppercase tracking-widest hover:bg-gray-300 active:bg-gray-200 focus:outline-none focus:border-gray-200 focus:ring ring-gray-300 transition ease-in-out duration-150">
                        Cancel
                    </a>
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:border-blue-800 focus:ring ring-blue-300 transition ease-in-out duration-150">
