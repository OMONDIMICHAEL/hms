    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden p-8">
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Fill in the details below to add a new room to the system.</p>
            </div>
            ...
            <form action="{{ route('rooms.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="room_number" id="room_number" required
                            ...
                            placeholder="e.g. 101" value="{{ old('room_number') }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="capacity" id="capacity" required min="1"
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100"
                            placeholder="e.g. 4" value="{{ old('capacity') }}">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Floor (Optional) -->
                <div>
                    <label for="floor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Floor (Optional)</label>
                    <div class="relative">
                        <input type="text" name="floor" id="floor"
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100"
                            placeholder="e.g. 1 or Ground Floor" value="{{ old('floor') }}">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
